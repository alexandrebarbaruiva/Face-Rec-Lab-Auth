...
\subsubsection*{Git Time Metric}


\begin{DoxyItemize}
\item G\+TM é usado para registrar o tempo gasto em cada arquivo e no total, útil para ter noção de onde a equipe está focando mais. Ele é leve, automático e há plugin para a maioria dos editores de texto. There is no need to remember to start and stop timers. It runs on occasion to capture activity triggered by your editor. The time metrics are stored locally with the git repository as Git notes and can be pushed to the remote repository.
\end{DoxyItemize}

Repositório\+: {\tt https\+://github.\+com/git-\/time-\/metric/gtm}

\subsubsection*{Catch Unit Testing (L\+E\+I\+AM)}
...
Repositório\+: {\tt https\+://github.\+com/philsquared/\+Catch}
...
Repositório\+: {\tt https\+://github.\+com/nlohmann/json}
...
\subsubsection*{Os arquivos}


\begin{DoxyEnumerate}
\item \doxyref{classes.\+cpp}{p.}{classes_8cpp}
\begin{DoxyItemize}
\item Onde está a implementação das classes
\end{DoxyItemize}
\item \doxyref{main.\+cpp}{p.}{main_8cpp}
\begin{DoxyItemize}
\item Onde está a implementação da C\+LI não terminada
\end{DoxyItemize}
\item rascunhos
\begin{DoxyItemize}
\item Usados para nortear o projeto
\end{DoxyItemize}
\end{DoxyEnumerate}
